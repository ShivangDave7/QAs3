...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Vita_Beahan25',
      password: 'gAGjeeQqvXV31G1',
      email: 'Alba65@yahoo.com',
      name: 'Christie Dooley',
      mobileNo: '1-601-764-3131 x11717',
      userType: 25,
      resetPasswordLink: {},
      loginRetryLimit: 285,
      loginReactiveTime: '2022-09-22T19:32:39.316Z',
      id: '623c4696accaab3a13e61c38'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Jo81',
        'password':'OAH_Gtnxo1SH4OI',
        'email':'Arturo.Bode@yahoo.com',
        'name':'Cora Bruen III',
        'mobileNo':'(214) 573-8402',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Arturo.Bode@yahoo.com', });
